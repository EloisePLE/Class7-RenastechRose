...
public class Q2 {
    //  Write a method where it takes a poem and returns the most Poetical Word (the word with the highest score) from the poem
    ...
    public static void main(String[] args) {
        System.out.println(mostPoeticalWord("kkkk mmmmm ssss"));
    }
